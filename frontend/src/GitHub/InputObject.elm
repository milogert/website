...
buildInviteEnterpriseAdminInput required fillOptionals =
    ...
    in
    { enterpriseId = required.enterpriseId, invitee = optionals.invitee, email = optionals.email, clientMutationId = optionals.clientMutationId }
...
encodeInviteEnterpriseAdminInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (GitHub.ScalarCodecs.codecs |> GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "invitee", Encode.string |> Encode.optional input.invitee ), ( "email", Encode.string |> Encode.optional input.email ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
buildMergePullRequestInput required fillOptionals =
    let
        optionals =
            fillOptionals
                { commitHeadline = Absent, commitBody = Absent, expectedHeadOid = Absent, clientMutationId = Absent }
    in
    { pullRequestId = required.pullRequestId, commitHeadline = optionals.commitHeadline, commitBody = optionals.commitBody, expectedHeadOid = optionals.expectedHeadOid, clientMutationId = optionals.clientMutationId }
...
encodeMergePullRequestInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (GitHub.ScalarCodecs.codecs |> GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "commitHeadline", Encode.string |> Encode.optional input.commitHeadline ), ( "commitBody", Encode.string |> Encode.optional input.commitBody ), ( "expectedHeadOid", (GitHub.ScalarCodecs.codecs |> GitHub.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input.expectedHeadOid ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeSponsorshipOrder input =
    Encode.maybeObject
        [ ( "direction", Encode.enum GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
buildUpdatePullRequestInput required fillOptionals =
    let
        optionals =
            fillOptionals
                { baseRefName = Absent, title = Absent, body = Absent, maintainerCanModify = Absent, clientMutationId = Absent }
    in
    { pullRequestId = required.pullRequestId, baseRefName = optionals.baseRefName, title = optionals.title, body = optionals.body, maintainerCanModify = optionals.maintainerCanModify, clientMutationId = optionals.clientMutationId }
