...
export const OverviewCard = () => (
  <div className="max-w-lg border rounded shadow-xl flex p-5 my-10 bg-white flex-col sm:flex-row items-center sm:items-start mx-4">
    ...
    <div className="items-center sm:items-start">
      <div className="text-xl mb-2">
        Milo Gertjejansen
        <div className="text-base text-yellow-900">Machine Sorcerer</div>
      </div>
      <div className="text-gray-700">
        <ul>
          <li className="flex justify-between">
            <span className="font-bold mr-2">GitHub</span>
            <a className="webLink" href="https://github.com/milogert">
          ...
          <li className="flex justify-between">
            ...
            <a className="webLink" href="https://linkedin.com/in/milogert">
